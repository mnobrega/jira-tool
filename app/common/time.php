...
function getEndDateFromWorkingHours (DateTime $startDate, $workingDays)
{
    global $holidays;
...
function getWorkingHours(Array $timeIntervals)
{
    global $holidays;

    $noofholiday = sizeof($holidays);
    $workhours = 0;
...
function sameday(DateTime $firstdate, DateTime $lastdate)
{
...
function firstday(DateTime $firstdate)   //calculation of hours of first day
{
...
function lastday(DateTime $lastdate)   //calculation of hours of last day
{
